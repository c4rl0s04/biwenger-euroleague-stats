...
export default function ColdStreaksCard() {
  ...
  return (
    <div className="bg-gradient-to-br from-cyan-900/20 to-slate-900 backdrop-blur-md border border-cyan-700/30 rounded-2xl p-6 relative overflow-hidden group hover:border-cyan-600/50 transition-all h-full flex flex-col">
