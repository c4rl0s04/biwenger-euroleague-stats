...
export default function RisingStarsCard() {
  ...
  return (
    <div className="bg-gradient-to-br from-emerald-900/20 to-slate-900 backdrop-blur-md border border-emerald-700/30 rounded-2xl p-6 relative overflow-hidden group hover:border-emerald-600/50 transition-all">
