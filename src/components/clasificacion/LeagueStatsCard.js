        ...
        <div className="space-y-3">
          <div className="grid grid-cols-2 gap-3">
            <div className="bg-slate-800/40 backdrop-blur-sm rounded-xl p-3 border border-slate-700/30 hover:border-cyan-500/30 transition-all">
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="text-slate-400 text-[10px] uppercase tracking-wider">Participantes</span>
              </div>
            ...
            <div className="bg-slate-800/40 backdrop-blur-sm rounded-xl p-3 border border-slate-700/30 hover:border-cyan-500/30 transition-all">
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="text-slate-400 text-[10px] uppercase tracking-wider">Total Puntos</span>
              </div>
              <div className="text-xl font-bold text-orange-400">{stats.total_points}</div>
              <div className="text-[10px] text-slate-500">Media: {stats.avg_round_points}/jornada</div>
            </div>
          </div>
          ...
          <div className="bg-slate-800/40 backdrop-blur-sm rounded-xl p-3 border border-slate-700/30 hover:border-cyan-500/30 transition-all">
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="text-slate-400 text-[10px] uppercase tracking-wider">Valor Total Liga</span>
            </div>
            <div className="text-xl font-bold text-blue-400">{formatPrice(stats.total_league_value)}</div>
          ...
          <div className="grid grid-cols-2 gap-3">
            {stats.round_record && (
              <div className="bg-gradient-to-r from-purple-500/10 to-pink-500/10 rounded-xl p-3 border border-purple-500/20">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span className="text-slate-400 text-[10px] uppercase tracking-wider">Récord Jornada</span>
                </div>
                <div className="text-xl font-bold text-purple-400">{stats.round_record.points} pts</div>
                <div className="text-[10px] text-slate-500">{stats.round_record.name} · {stats.round_record.round_name}</div>
              </div>
            )}
            ...
            <div className="bg-gradient-to-r from-orange-500/10 to-red-500/10 rounded-xl p-3 border border-orange-500/20">
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="text-slate-400 text-[10px] uppercase tracking-wider">Racha Líder</span>
              </div>
          ...
          {stats.most_valuable_user && (
            <div className="bg-gradient-to-r from-yellow-500/10 to-amber-500/10 rounded-xl p-3 border border-yellow-500/20">
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="text-slate-400 text-[10px] uppercase tracking-wider">Plantilla Más Valiosa</span>
              </div>
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  {stats.most_valuable_user.icon ? (
                    <img src={stats.most_valuable_user.icon} alt={stats.most_valuable_user.name} className="w-6 h-6 rounded-full" />
                  ) : (
                    <div className="w-6 h-6 rounded-full bg-slate-700 flex items-center justify-center text-xs font-medium">{stats.most_valuable_user.name.charAt(0)}</div>
                  )}
                  <span className="font-medium text-white text-sm">{stats.most_valuable_user.name}</span>
                </div>
                <span className="text-yellow-400 font-bold text-sm">{formatPrice(stats.most_valuable_user.team_value)}</span>
              </div>
            </div>
          )}
            ...
            return (
              <div className="bg-slate-800/40 backdrop-blur-sm rounded-xl p-3 border border-slate-700/30">
                <div className="flex items-center justify-between mb-2">
                  <span className="text-slate-400 text-[10px] uppercase tracking-wider">Progreso Temporada</span>
                  <span className="text-slate-300 text-xs font-medium">{playedRounds} / {TOTAL_ROUNDS}</span>
                </div>
