                ...
                <div className="mb-8 grid grid-cols-1 gap-8 md:mb-12 md:grid-cols-4 md:gap-12">
                  ...
                  <div className="col-span-1 md:col-span-2 space-y-6">
                    ...
                    <p className="text-sm text-slate-400 leading-relaxed max-w-sm font-sans">
                      El compañero analítico definitivo para mánagers de Biwenger Euroliga. Domina
                      tu liga con datos en tiempo real, métricas de rendimiento avanzadas y
                      herramientas visuales de élite.
                    </p>
                  </div>
