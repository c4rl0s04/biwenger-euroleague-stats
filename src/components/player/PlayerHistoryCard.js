            ...
            {recentMatches && recentMatches.length > 0 ? (
              recentMatches.map((match) => {
                ...
                return (
                  <tr
                    key={match.round_id}
                    className={`hover:bg-slate-700/10 transition-colors group ${!played ? 'opacity-50' : ''}`}
                  >
                    ...
                    <td className="px-4 py-3">
                      <div className="flex items-center gap-2">
                        ...
                        <span
                          className="text-slate-300 truncate max-w-[120px] md:max-w-none"
                          title={rivalName}
                        >
                          {rivalName || '-'}
                        </span>
                    ...
                    {played ? (
                      <>
                        <td className="px-4 py-3 text-center">
                          <span
                            className={`inline-block w-8 py-1 rounded font-bold text-xs ${getScoreColor(match.fantasy_points)}`}
                          >
                        ...
                        <td className="px-4 py-3 text-center font-bold text-slate-300 hidden md:table-cell">
                          {match.points_scored || 0}
                        </td>
