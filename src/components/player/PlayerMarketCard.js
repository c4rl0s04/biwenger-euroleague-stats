    ...
    >
      <div className="flex flex-col h-full justify-between">
        <div className="flex justify-between items-start">
          ...
          <div
            className={`text-right ${player.price_increment >= 0 ? 'text-emerald-400 bg-emerald-500/10' : 'text-rose-400 bg-rose-500/10'} px-3 py-2 rounded-lg border ${player.price_increment >= 0 ? 'border-emerald-500/20' : 'border-rose-500/20'}`}
          >
            <div className="text-[10px] uppercase tracking-wider opacity-80 mb-0.5 font-bold">
              Cambio
            </div>
