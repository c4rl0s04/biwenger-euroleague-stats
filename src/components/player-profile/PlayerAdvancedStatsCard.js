...
const StatBox = ({ icon: Icon, label, total, avg, color }) => (
  <div className="flex flex-col bg-black/20 rounded-xl p-3 border border-white/5 hover:bg-black/40 transition-colors group">
    ...
    <div className="flex items-end justify-between mt-auto">
      <div className="flex flex-col">
        ...
        <span className="text-[9px] text-white/80 uppercase tracking-widest mt-1">Total</span>
      </div>
      <div className="flex flex-col text-right">
        <span className="text-lg font-bold text-white leading-none">{avg}</span>
        <span className="text-[9px] text-white/80 uppercase tracking-widest mt-1">Media</span>
      </div>
    </div>
  </div>
);
  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 mt-4">
        {/* LEFT COLUMN: Shooting Splits */}
        <div className="lg:col-span-5 flex flex-col h-full">
          <h4 className="flex items-center gap-2 text-sm font-bold text-white mb-5">
            <Crosshair className="w-4 h-4 text-indigo-400" /> Eficiencia de Tiro
          </h4>

          <div className="bg-black/20 p-5 rounded-2xl border border-white/5 flex-1 flex flex-col justify-evenly">
            <ShootingBar
              label="Tiros de 2"
              pct={pct2}
            ...
            <ShootingBar
              ...
              barColorClass="bg-cyan-500 shadow-[0_0_10px_rgba(6,182,212,0.5)]"
            />
            <ShootingBar
              label="Tiros Libres"
              pct={pctFT}
              ...
              barColorClass="bg-emerald-500 shadow-[0_0_10px_rgba(16,185,129,0.5)]"
            />
          </div>
        </div>
        ...
        <div className="lg:col-span-7">
          <h4 className="flex items-center gap-2 text-sm font-bold text-white mb-5">
            <Activity className="w-4 h-4 text-indigo-400" /> Impacto en Pista
          </h4>
          ...
          <div className="grid grid-cols-2 gap-3 mt-3">
            <div className="flex items-center justify-between bg-black/20 p-3 rounded-xl border border-white/5">
              <span className="text-[10px] text-white/90 font-black tracking-widest uppercase">
                Faltas Cometidas
              </span>
              <span className="text-sm font-bold text-white">{s.fouls}</span>
            </div>
            <div className="flex items-center justify-between bg-black/20 p-3 rounded-xl border border-white/5">
              <span className="text-[10px] text-white/90 font-black tracking-widest uppercase">
                Partidos Jugados
              </span>
              <span className="text-sm font-bold text-white">{s.games_played}</span>
            </div>
          </div>
        </div>
      </div>
