...
import { ResponsiveContainer, ComposedChart, Bar, XAxis, YAxis, Tooltip, ErrorBar, Scatter } from 'recharts';
...
export default function FloorCeilingCard() {
  ...
  return (
    <Card title="Suelo y Techo" icon={ArrowUpDown} color="cyan" loading={loading} tooltip="Rango de puntuación (Mínimo - Máximo). La línea indica la media.">
        ...
        <div className="h-72 w-full">
          <ResponsiveContainer width="100%" height="100%">
            ...
            >
              ...
              <Bar dataKey="range" barSize={12} fill="#334155" radius={[4, 4, 4, 4]} background={{ fill: 'transparent' }} />
