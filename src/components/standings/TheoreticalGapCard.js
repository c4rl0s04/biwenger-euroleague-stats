...
export default function TheoreticalGapCard() {
  ...
  return (
    <Card title="Gap Teórico (Eficiencia)" icon={Goal} color="emerald" loading={loading} tooltip="Distancia acumulada respecto a la 'Temporada Perfecta' (suma de los ganadores de cada jornada).">
