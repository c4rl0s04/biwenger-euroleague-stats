  ...
  return (
    <div className="hover:scale-[1.02] transition-transform duration-200">
      <ElegantCard
        ...
        icon={Skull}
        color="red"
        info="El jugador que más pérdidas totales ha causado a todos los usuarios que lo han comprado y vendido."
      >
        <div className="flex flex-col">
          ...
          <div className="mt-2 text-center">
            ...
            <div className="text-xl md:text-2xl font-black text-red-400 mt-1">
              -{formatEuro(winner.total_loss)}{' '}
              <span className="text-sm md:text-base font-bold text-zinc-500">€ perdidos</span>
            </div>

            <p className="text-[10px] text-zinc-500 font-bold">
              {winner.trade_count} operaciones ruinosas
            </p>
          </div>
