...
import { Tag, ChevronDown, ChevronUp, Award } from 'lucide-react';
        ...
        >
          <div className="flex flex-col">
            ...
            <div className="relative mt-2">
              ...
              {/* Points Per Million Display */}
              <div className="mt-3 text-center">
                <span className="text-2xl font-black text-amber-400">
                  {winner.points_per_million?.toFixed(1)}{' '}
                  <span className="text-sm text-zinc-500">pts/M</span>
                </span>
                <div className="flex justify-center gap-4 text-xs mt-1">
                  <div className="flex flex-col items-center">
                    <span className="text-zinc-500 font-medium">Total Pts</span>
