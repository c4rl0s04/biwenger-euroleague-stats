...
export default function WorstRevaluationCard({ data }) {
  ...
  const maxDevaluation = Math.max(...data.map((d) => Math.abs(d.devaluation)));
          ...
          <div className="relative mt-2">
            ...
            <div className="flex justify-center mb-3">
              <div className="relative">
                <div className="w-20 h-20 rounded-full overflow-hidden ring-4 ring-pink-500/50 shadow-lg shadow-pink-500/20">
                  <PlayerImage
            ...
            <div className="text-center">
              <Link href={`/player/${winner.player_id}`} className="group">
                <span className="text-lg font-black text-white group-hover:text-pink-400 transition-colors">
                  {winner.player_name}
                </span>
              </Link>
            </div>
