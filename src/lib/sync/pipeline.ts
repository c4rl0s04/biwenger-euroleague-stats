...
export const PIPELINE: readonly SyncStepDefinition[] = [
  ...
  },
  {
    ...
    source: 'euroleague',
    writes: ['official_team_standings', 'official_team_mappings', 'official_player_mappings'],
    modes: ['routine', 'bootstrap'],
  ...
  },
  {
    ...
    source: 'euroleague',
    writes: ['matches', 'player_round_stats:sporting', 'official_play_by_play', 'official_shots'],
