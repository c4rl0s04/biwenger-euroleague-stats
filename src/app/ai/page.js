            ...
            <div className="h-full flex flex-col items-center justify-center text-center p-8 space-y-6 opacity-60">
              ...
              <div className="max-w-md space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Pregúntame sobre estadísticas de jugadores, la clasificación actual o
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 w-full max-w-lg mt-8">
                {[
                  ...
                  'Top 5 jugadores',
                  'Valor de mercado de Bellingham',
                ].map((q) => (
                  <button
                    key={q}
                    onClick={() => {
            ...
            >
              ...
              >
                ...
                {m.toolInvocations?.map((tool) => (
                  <div
                    key={tool.toolCallId}
                    className="mt-3 flex items-center gap-2 text-xs bg-black/5 dark:bg-white/5 px-3 py-1.5 rounded-full w-fit"
                  >
