...
vi.mock('../../catalogue/server/services/market-catalogue.service', () => ({
  getCurrentMarketListings: fake.listings,
}));
vi.mock('../../trends/server/services/market-activity.service', () => ({
  getMarketKPIs: fake.kpis,
}));
vi.mock('../../trends/server/services/market-activity-extra.service', () => ({
  getRecentTransfers: fake.transfers,
}));
