import 'server-only';
import { getManagerDirectory as getAllUsers } from '@/features/managers/server';
...
import { getMarketTrendsAnalysis } from './market-trends.service';
import { getCurrentMarketListings } from './market-catalogue.service';
