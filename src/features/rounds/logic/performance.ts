...
export interface CalculatedPerformanceStats<T extends RoundPerformance = RoundPerformance> {
...
export function calculateStats<T extends RoundPerformance>(
  history?: T[] | null
): CalculatedPerformanceStats<T> | null {
