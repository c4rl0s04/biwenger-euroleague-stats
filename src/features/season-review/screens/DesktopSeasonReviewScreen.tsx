...
import { buildEvolutionChartModel, type EvolutionMetric } from '../models/evolution-chart';
import type { ResilienceConfig, SeasonReviewOverviewV2 } from '../models/types';
import type {
...
export default function DesktopSeasonReviewScreen({
  overview,
  simulationAnalysis,
}: {
