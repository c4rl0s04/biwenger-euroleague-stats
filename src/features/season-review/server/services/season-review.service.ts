...
import {
  ...
  gini,
  simulateRecovery,
} from '../engines/resilience';
import { runSeasonMonteCarlo } from '../engines/season-simulator';
import {
  buildSeasonSimulationDataset,
  calibrateSeasonSimulator,
} from '../engines/simulation-dataset';
import {
  getSeasonReviewRawData,
  type SeasonReviewRawData,
} from '../queries/season-review-raw.query';

export const STARTING_BUDGET = 40_000_000;
...
export function sameConfig(left: ResilienceConfig, right: ResilienceConfig) {
  return (
...
export function sameShock(left: ShockConfig, right: ShockConfig) {
  return (
...
export async function buildResilienceModel() {
...
export const getCachedResilienceModel = () =>
