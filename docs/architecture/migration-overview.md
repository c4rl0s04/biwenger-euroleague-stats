...
Schedule (Task 04) is now implemented locally, not merged or deployed; see its
[acceptance receipt](../migration/reports/task-04-schedule.md), including the existing verification-wrapper limitation.
