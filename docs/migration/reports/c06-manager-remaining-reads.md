...
- **Personalized Alerts**: 3 sequential queries (`price_increment > 500000`, `price_increment < -500000`, `fantasy_points >= 25` on max round). Price increments formatted in M€ with 2 decimals. Default limit is `5`.
