---
title: Batch 009 — Compare read composition
...
- Intended scope: Migrate the existing comparison screens and read orchestration.
- Required discovery: Inspect both comparison routes and data APIs, selection/query semantics and shared cards. Assign the legacy Rounds HeadToHeadCard by actual ownership.
- Dependency review: Standings, Managers and Rounds contracts; preserve unrelated manager selectors/shell.
