---
title: Batch 008 — Dashboard read composition
...
Historical worker placeholder. Current scope and dependencies are in [tracker Tasks 06–07](../tracker.md).
...
- Intended scope: Migrate Dashboard composition after its owning statistical services are available.
- Required discovery: Inventory every desktop card, phone section and existing API consumer. Preserve session fallback/private headers and independent loading.
- Dependency review: Standings, Managers, Players, Teams, Rounds and public Market read contracts as actually consumed.
