---
title: Batch 006 — Schedule composition
...
- Intended scope: Complete Schedule screens and squad-overlay read composition.
- Required discovery: Inspect desktop/phone/map routes and overlay consumers. Reuse Matches map contracts and Rounds calendar; no game-query duplication.
- Dependency review: Manager squad public/server contract; no private Lineup behavior changes.
